...
import { NotesService } from 'app/zdslogic-ui-shell/modules/admin/apps/notes/notes.service';
import { Label, Note } from 'app/zdslogic-ui-shell/modules/admin/apps/notes/notes.types';
...
export class NotesListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.notes$ = combineLatest([this._notesService.notes$, this.filter$, this.searchQuery$]).pipe(
            ...
            map(([notes, filter, searchQuery]): any {
