...
import { Board, Card, Label, List } from 'app/zdslogic-ui-shell/modules/admin/apps/scrumboard/scrumboard.models';
...
export class ScrumboardService
{
    ...
    createList(list: List): Observable<List>
    {
        return this._httpClient.post<List>('api/apps/scrumboard/board/list', {list}).pipe(
            ...
            tap((newList): any {
                ...
                board.lists.sort((a, b): any a.position - b.position);
    ...
    createCard(card: Card): Observable<Card>
    {
        return this._httpClient.put<Card>('api/apps/scrumboard/board/card', {card}).pipe(
            ...
            tap((newCard): any {
                ...
                board.lists.forEach((listItem, index, list): any {
            ...
            switchMap(board => this._httpClient.patch<Card>('api/apps/scrumboard/board/card', {
                ...
                map((updatedCard): any {
                    ...
                    board.lists.forEach((listItem): any {
                        listItem.cards.forEach((cardItem, index, array): any {
                            if ( cardItem.id === id )
                            {
        ...
        return this._httpClient.patch<Card[]>('api/apps/scrumboard/board/cards', {cards}).pipe(
            ...
            tap((updatedCards): any {
                ...
                updatedCards.forEach((updatedCard): any {
                    ...
                    // Sort the cards
                    board.lists[listIndex].cards.sort((a, b): any a.position - b.position);
                });
    ...
    updateCardPositions(cards: Card[]): void // Observable<Card[]>
    {
        /*return this._httpClient.patch<Card[]>('api/apps/scrumboard/board/card/positions', {cards}).pipe(
            map((response): any response.map((item): any new Card(item))),
            tap((updatedCards): any {
