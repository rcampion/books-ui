...
import { Contact, Country, Tag } from 'app/zdslogic-ui-shell/modules/admin/apps/contacts/contacts.types';
import { ContactsListComponent } from 'app/zdslogic-ui-shell/modules/admin/apps/contacts/list/list.component';
import { ContactsService } from 'app/zdslogic-ui-shell/modules/admin/apps/contacts/contacts.service';
...
export class ContactsDetailsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._contactsService.contacts$
            ...
            .subscribe((contacts: Contact[]): any {
        ...
        this._contactsService.contact$
            ...
            .subscribe((contact: Contact): any {
                ...
                emailFormGroups.forEach((emailFormGroup): any {
                ...
                phoneNumbersFormGroups.forEach((phoneNumbersFormGroup): any {
