...
import { AcademyService } from 'app/zdslogic-ui-shell/modules/admin/apps/academy/academy.service';
import { Category, Course } from 'app/zdslogic-ui-shell/modules/admin/apps/academy/academy.types';
...
export class AcademyListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([this.filters.categorySlug$, this.filters.query$, this.filters.hideCompleted$])
            .subscribe(([categorySlug, query, hideCompleted]): any {
