...
import { FUSE_MOCK_API_DEFAULT_DELAY, FuseMockApiInterceptor } from 'app/zdslogic-ui-shell/@fuse/lib/mock-api';
import { FuseConfig } from 'app/zdslogic-ui-shell/@fuse/services/config';
import { FUSE_CONFIG } from 'app/zdslogic-ui-shell/@fuse/services/config/config.constants';
import { FuseConfirmationService } from 'app/zdslogic-ui-shell/@fuse/services/confirmation';
import { fuseLoadingInterceptor, FuseLoadingService } from 'app/zdslogic-ui-shell/@fuse/services/loading';
...
import { FuseSplashScreenService } from 'app/zdslogic-ui-shell/@fuse/services/splash-screen';
import { FuseUtilsService } from 'app/zdslogic-ui-shell/@fuse/services/utils';
...
export const provideFuse = (config: FuseProviderConfig): Array<Provider | EnvironmentProviders> =>
{
    ...
    {
        providers.push(
            provideHttpClient(withInterceptors([FuseMockApiInterceptor])),
            {
