...
@Component({
	selector: 'app-contact-note-details-dialog',
	templateUrl: './contact-note-details-dialog.component.html',
	styleUrls: ['./contact-note-details-dialog.component.scss']
})
export class ContactNoteDetailsDialogComponent implements OnInit {
	noteId: string;
	public note: Note;
	...
	constructor(private _angularLogService: AngularLogService,
		...
		private _dialogRef: MatDialogRef<ContactNoteDetailsDialogComponent>,
