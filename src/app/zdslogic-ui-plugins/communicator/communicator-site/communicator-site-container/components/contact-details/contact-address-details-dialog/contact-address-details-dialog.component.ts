...
@Component({
	selector: 'app-contact-address-details-dialog',
	templateUrl: './contact-address-details-dialog.component.html',
	styleUrls: ['./contact-address-details-dialog.component.scss']
})
export class ContactAddressDetailsDialogComponent implements OnInit {
	addressId: string;
	...
	constructor(private _angularLogService: AngularLogService,
		...
		private _dialogRef: MatDialogRef<ContactAddressDetailsDialogComponent>,
