...
export class Dialog {
  ...
  public get early(): boolean {
    return this._dialogState.early;
  }

  /** Call identifier component of the dialog id. */
  public get callId(): string {
    return this._dialogState.callId;
  }

  /** Local tag component of the dialog id. */
  public get localTag(): string {
    return this._dialogState.localTag;
  }

  /** Remote tag component of the dialog id. */
  public get remoteTag(): string {
    return this._dialogState.remoteTag;
  }

  /** Local sequence number (used to order requests from the UA to its peer). */
  public get localSequenceNumber(): number | undefined {
    return this._dialogState.localSequenceNumber;
  }

  /** Remote sequence number (used to order requests from its peer to the UA). */
  public get remoteSequenceNumber(): number | undefined {
    return this._dialogState.remoteSequenceNumber;
  }

  /** Local URI. */
  public get localURI(): URI {
    return this._dialogState.localURI;
  }

  /** Remote URI. */
  public get remoteURI(): URI {
    return this._dialogState.remoteURI;
  }

  /** Remote target. */
  public get remoteTarget(): URI {
    return this._dialogState.remoteTarget;
  }
  ...
  public get routeSet(): Array<string> {
    return this._dialogState.routeSet;
  }
  ...
  public get secure(): boolean {
    return this._dialogState.secure;
  }
  ...
  public receiveRequest(message: IncomingRequestMessage): void {
    ...
    if (this.remoteSequenceNumber) {
      ...
      this._dialogState.remoteSequenceNumber = message.cseq;
    }
  ...
  public recomputeRouteSet(message: IncomingResponseMessage): void {
    this._dialogState.routeSet = message.getHeaders("record-route").reverse();
  }
  ...
  public createOutgoingRequestMessage(
    ...
    if (options && options.cseq) {
      cseq = options.cseq;
    } else if (!this._dialogState.localSequenceNumber) {
      cseq = this._dialogState.localSequenceNumber = 1; //  https://tools.ietf.org/html/rfc3261#section-8.1.1.5
    } else {
      cseq = this._dialogState.localSequenceNumber += 1;
    }
  ...
  public incrementLocalSequenceNumber(): void {
    if (!this._dialogState.localSequenceNumber) {
      throw new Error("Local sequence number undefined.");
    }
    this._dialogState.localSequenceNumber += 1;
  }
