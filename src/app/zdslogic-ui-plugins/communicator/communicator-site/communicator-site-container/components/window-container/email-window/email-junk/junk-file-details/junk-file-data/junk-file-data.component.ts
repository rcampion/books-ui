...
@Component({
	selector: 'app-junk-file-data',
	templateUrl: './junk-file-data.component.html',
	styleUrls: ['./junk-file-data.component.scss']
})
export class JunkFileDataComponent implements OnInit, AfterViewInit, AfterContentInit {
	@Input() public file: EMailJunkFile;
