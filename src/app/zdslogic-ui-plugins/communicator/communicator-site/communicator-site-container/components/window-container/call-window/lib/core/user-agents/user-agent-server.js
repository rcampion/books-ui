...
export class UserAgentServer {
    constructor(transactionConstructor, core, message, delegate) {
        ...
        this._angularLogService = this._angularLogServiceFactory.getLogger("sip.user-agent-server");
        ...
        const user = {
            ...
            onTransportError: (error) => {
                ...
                if (this.delegate && this.delegate.onTransportError) {
                    ...
                    this._angularLogService.error("User agent server response transport error.");
                }
            }
        };
