...
export class SessionDialog extends Dialog implements Session {
  ...
  constructor(
    ...
    this._angularLogService = core.loggerFactory.getLogger("sip.invite-dialog");
    this._angularLogService.log(`INVITE dialog ${this.id} constructed`);
  }
  ...
  public dispose(): void {
    ...
    this._angularLogService.log(`INVITE dialog ${this.id} destroyed`);
  }
  ...
  public ack(options: RequestOptions = {}): OutgoingAckRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending ACK request`);
  ...
  public bye(delegate?: OutgoingRequestDelegate, options?: RequestOptions): OutgoingByeRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending BYE request`);
  ...
  public info(delegate?: OutgoingRequestDelegate, options?: RequestOptions): OutgoingInfoRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending INFO request`);
    if (this.early) {
      // FIXME: TODO: This should throw a proper exception.
  ...
  public invite(delegate?: OutgoingInviteRequestDelegate, options?: RequestOptions): OutgoingInviteRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending INVITE request`);
    if (this.early) {
      // FIXME: TODO: This should throw a proper exception.
      throw new Error("Dialog not confirmed.");
    }
  ...
  public message(delegate: OutgoingRequestDelegate, options?: RequestOptions): OutgoingMessageRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending MESSAGE request`);
    if (this.early) {
      // FIXME: TODO: This should throw a proper exception.
      throw new Error("Dialog not confirmed.");
    }
  ...
  public notify(delegate?: OutgoingRequestDelegate, options?: RequestOptions): OutgoingNotifyRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending NOTIFY request`);
    if (this.early) {
      // FIXME: TODO: This should throw a proper exception.
      throw new Error("Dialog not confirmed.");
    }
  ...
  public prack(delegate?: OutgoingRequestDelegate, options?: RequestOptions): OutgoingPrackRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending PRACK request`);
  ...
  public refer(delegate?: OutgoingRequestDelegate, options?: RequestOptions): OutgoingReferRequest {
    this._angularLogService.log(`INVITE dialog ${this.id} sending REFER request`);
    if (this.early) {
      // FIXME: TODO: This should throw a proper exception.
      throw new Error("Dialog not confirmed.");
    }
  ...
  public receiveRequest(message: IncomingRequestMessage): void {
    this._angularLogService.log(`INVITE dialog ${this.id} received ${message.method} request`);
    ...
    if (message.method === C.ACK) {
      ...
      if (this.ackWait) {
        if (this.initialTransaction instanceof InviteClientTransaction) {
          this._angularLogService.warn(`INVITE dialog ${this.id} received unexpected ${message.method} request, dropping.`);
          return;
        }
    ...
    if (!this.sequenceGuard(message)) {
      this._angularLogService.log(`INVITE dialog ${this.id} rejected out of order ${message.method} request.`);
      return;
    }
    ...
    if (message.method === C.INVITE) {
      ...
      const warning = (): void => {
        ...
        this._angularLogService.warn(`INVITE dialog ${this.id} received re-INVITE while ${reason}`);
        ...
        this._angularLogService.warn(msg);
    ...
    if (message.method === C.INVITE) {
      ...
      this._dialogState.remoteTarget = contact.uri;
    }
    ...
    switch (message.method) {
      ...
      default:
        {
          this._angularLogService.log(`INVITE dialog ${this.id} received unimplemented ${message.method} request`);
  ...
  private start2xxRetransmissionTimer(): void {
    if (this.initialTransaction instanceof InviteServerTransaction) {
      ...
      const retransmission = (): void => {
        ...
        this._angularLogService.log("No ACK for 2xx response received, attempting retransmission");
