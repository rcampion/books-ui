...
export class InviteClientTransaction extends ClientTransaction {
     ...
     */
    timerB() {
        this._angularLogService.debug(`Timer B expired for INVITE client transaction ${this.id}.`);
        if (this.state === TransactionState.Calling) {
     ...
     */
    timerD() {
        this._angularLogService.debug(`Timer D expired for INVITE client transaction ${this.id}.`);
     ...
     */
    timerM() {
        this._angularLogService.debug(`Timer M expired for INVITE client transaction ${this.id}.`);
