...
export abstract class Transaction {
  ...
  protected constructor(
    ...
    this._angularLogService = _user.loggerFactory.getLogger(loggerCategory, _id);
    this._angularLogService.debug(`Constructing ${this.typeToString()} with id ${this.id}.`);
  }
   ...
   */
  public dispose(): void {
    this._angularLogService.debug(`Destroyed ${this.typeToString()} with id ${this.id}.`);
  }
  ...
  protected logTransportError(error: TransportError, message: string): void {
    ...
    this._angularLogService.error(`Transport error occurred in ${this.typeToString()} with id ${this.id}.`);
  ...
  protected setState(state: TransactionState): void {
    this._angularLogService.debug(`State change to "${state}" on ${this.typeToString()} with id ${this.id}.`);
    this._state = state;
