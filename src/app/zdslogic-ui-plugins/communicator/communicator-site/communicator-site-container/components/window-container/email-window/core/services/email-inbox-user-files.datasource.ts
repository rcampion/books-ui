...
import { EMailInboxUserFilesService } from './email-inbox-user-files.service';
...
export class EMailInboxUserFilesDataSource implements DataSource<EMailInboxFile> {

    public filesSubject = new BehaviorSubject<EMailInboxFile[]>([]);
    ...
    constructor(
		private filesService: EMailInboxUserFilesService,
    ...
    connect(collectionViewer: CollectionViewer): Observable<EMailInboxFile[]> {
