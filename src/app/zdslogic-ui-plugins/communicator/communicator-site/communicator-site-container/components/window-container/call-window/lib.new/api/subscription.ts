...
export abstract class Subscription {
  ...
  protected constructor(userAgent: UserAgent, options: SubscriptionOptions = {}) {
    this._angularLogService = userAgent.getLogger("sip.Subscription");
  ...
  protected stateTransition(newState: SubscriptionState): void {
    ...
    this._angularLogService.log(`Subscription ${this._dialog ? this._dialog.id : undefined} transitioned to ${this._state}`);
