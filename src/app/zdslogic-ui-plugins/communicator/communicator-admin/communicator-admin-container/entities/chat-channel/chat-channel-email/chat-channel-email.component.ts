...
@Component({
	selector: 'app-chat-channel-email',
	templateUrl: './chat-channel-email.component.html',
	styleUrls: ['./chat-channel-email.component.scss']
})
export class ChatChannelEMailComponent implements OnInit {
	...
	private executeSendEMail(emailFormValue): void {
		...
		let apiUrl = 'contacts/chat-channel/email/send';

		if (this.files !== undefined) {
			filedata = this.files[0];
			formData.append('file', filedata);
			apiUrl = 'contacts/chat-channel/email/send/with/file';
		}
