...
@UntilDestroy()
@Component({
	selector: 'app-communicator-admin-container',
	templateUrl: './communicator-admin-container.component.html',
	styleUrls: ['./communicator-admin-container.component.scss'],
	encapsulation: ViewEncapsulation.None,
})
export class CommunicatorAdminContainerComponent implements OnInit {
		...
		private getProfileDetails = (): void => {
			...
			if (username !== undefined) {
				...
				this._profilesService.getData(apiUrl)
					.subscribe((result) => {
						this.profileEntity = result as ProfileEntity;
		...
		this.menuData = [
			{
				...
				children: [
					{
						id: 'entities.chat-channel',
						title: 'Channel',
						type: 'basic',
						icon: 'heroicons_outline:table',
						link: '/communicator-admin/channel'
					},
/*
					{
