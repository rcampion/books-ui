...
export class DataService {
	...
	userDetails: any = {
		'richard.campion@yahoo.com': { email: 'richard.campion@yahoo.com', username: 'Richard', password: 1000 },
		'gcm0006@gmail.com': { email: 'gcm0006@gmail.com', username: 'Goushith', password: 1001 },
		'rafnas@gmail.com': { email: 'rafnas@gmail.com', username: 'Rafnas', password: 1002 },
		'anujith@gmail.com': { email: 'anujith@gmail.com', username: 'Anujith', password: 1003 },
	}

	register(email: any, username: any, password: any): boolean {
	...
	login(email: any, pswd: any): boolean {
		const userDetails = this.userDetails;
		if (email in userDetails) {
