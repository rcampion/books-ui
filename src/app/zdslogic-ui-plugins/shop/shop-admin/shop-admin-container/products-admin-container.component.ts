...
@UntilDestroy()
@Component({
	selector: 'app-shop-admin-container',
	templateUrl: './shop-admin-container.component.html',
	styleUrls: ['./shop-admin-container.component.scss'],
	encapsulation: ViewEncapsulation.None,
})
export class ProductsAdminContainerComponent implements OnInit {
		...
		this.menuData = [
			{
				...
				children: [
					...
					},
					{
						...
						type: 'basic',
						icon: 'heroicons_outline:table',
						link: '/shop-admin/address-status'
					},
					{
						id: 'entities.author',
						title: 'Author',
