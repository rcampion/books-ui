...
export class ProductUpdateComponent implements OnInit {
	public book: Product = new Product();
	...
	public updateProduct(bookFormValue): void {
		if (this.bookForm.valid) {
			this.executeProductUpdate(bookFormValue);
		}
	}
	...
	private executeProductUpdate(bookFormValue): void {
		const book: Product = {
