...
@Component({
	selector: 'app-product-sku-delete-dialog',
	templateUrl: './product-sku-delete-dialog.component.html',
	styleUrls: ['./product-sku-delete-dialog.component.scss']
})
export class ProductSkuDeleteDialogComponent implements OnInit {
	id: string;
	constructor(private _angularLogService: AngularLogService,
		...
		private _dialogRef: MatDialogRef<ProductSkuDeleteDialogComponent>,
