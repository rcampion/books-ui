...
export class GroupsService {
    ...
    findGroupsWithSortAndFilter(
        ...
        let apiUrl = this.createCompleteRoute('group', environment.apiUrl);
        ...
        let search: string;
        if (filter !== '') {
            apiUrl = this.createCompleteRoute('group/search', environment.apiUrl);

			const groupName = '\'*' + filter + '*\'';
			const groupDescription = '\'*' + filter + '*\'';

			search = 'groupName==' + groupName + ' or ' + 'groupDescription==' + groupDescription;
        }
