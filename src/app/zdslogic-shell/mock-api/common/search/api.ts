...
import { FuseNavigationItem, FuseNavigationService } from 'app/zdslogic-shell/@fuse/components/navigation';
import { FuseMockApiService } from 'app/zdslogic-shell/@fuse/lib/mock-api';
import { defaultNavigation } from 'app/zdslogic-shell/mock-api/common/navigation/data';
import { contacts } from 'app/zdslogic-shell/mock-api/apps/contacts/data';
import { tasks } from 'app/zdslogic-shell/mock-api/apps/tasks/data';
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                if ( contactsResults.length > 0 )
                {
                    ...
                    contactsResults.forEach((result: any) => {
                ...
                {
                    // Normalize the results
                    tasksResults.forEach((result: any) => {
