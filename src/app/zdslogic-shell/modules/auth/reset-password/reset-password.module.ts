...
import { AuthResetPasswordComponent } from 'app/zdslogic-shell/modules/auth/reset-password/reset-password.component';
import { authResetPasswordRoutes } from 'app/zdslogic-shell/modules/auth/reset-password/reset-password.routing';
