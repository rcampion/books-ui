...
import { Contact, Country, Tag } from 'app/zdslogic-shell/modules/admin/apps/contacts/contacts.types';
import { ContactsListComponent } from 'app/zdslogic-shell/modules/admin/apps/contacts/list/list.component';
import { ContactsService } from 'app/zdslogic-shell/modules/admin/apps/contacts/contacts.service';
