...
import { AcademyService } from 'app/zdslogic-shell/modules/admin/apps/academy/academy.service';
import { Category, Course } from 'app/zdslogic-shell/modules/admin/apps/academy/academy.types';
