...
import { NotesDetailsComponent } from 'app/zdslogic-shell/modules/admin/apps/notes/details/details.component';
import { NotesLabelsComponent } from 'app/zdslogic-shell/modules/admin/apps/notes/labels/labels.component';
import { NotesService } from 'app/zdslogic-shell/modules/admin/apps/notes/notes.service';
import { Label, Note } from 'app/zdslogic-shell/modules/admin/apps/notes/notes.types';
