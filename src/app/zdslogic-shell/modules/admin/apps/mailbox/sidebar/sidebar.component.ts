...
import { labelColorDefs } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.constants';
import { MailFilter, MailFolder, MailLabel } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.types';
...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._mailboxService.filters$
            ...
            .subscribe((filters: MailFilter[]): any {
        ...
        this._mailboxService.folders$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((folders: MailFolder[]): any {
