...
import { MailboxFiltersResolver, MailboxFoldersResolver, MailboxLabelsResolver, MailboxMailResolver, MailboxMailsResolver } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.resolvers';
