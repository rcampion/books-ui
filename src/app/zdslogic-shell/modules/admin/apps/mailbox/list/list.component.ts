...
import { Mail, MailCategory } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.types';
...
export class MailboxListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._mailboxService.category$
            ...
            .subscribe((category: MailCategory): any {
        ...
        this._mailboxService.mailsLoading$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((mailsLoading: boolean): any {
