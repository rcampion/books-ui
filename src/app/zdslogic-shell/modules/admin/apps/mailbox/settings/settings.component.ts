...
import { MailboxService } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.service';
import { MailLabel } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.types';
import { labelColorDefs, labelColors } from 'app/zdslogic-shell/modules/admin/apps/mailbox/mailbox.constants';
...
export class MailboxSettingsComponent implements OnInit
{
    ...
    labels: MailLabel[];
    labelsForm: UntypedFormGroup = new UntypedFormGroup({
    ...
    ngOnInit(): void
    {
        ...
        this._mailboxService.labels$
            .pipe(take(1))
            .subscribe((labels: MailLabel[]): any {
    ...
    addLabel(): void
    {
        ...
        this._mailboxService.addLabel(this.labelsForm.get('newLabel').value).subscribe((addedLabel): any {
    ...
    updateLabels(): void
    {
        ...
        (this.labelsForm.get('labels') as UntypedFormArray).controls.forEach((labelFormGroup): any {
