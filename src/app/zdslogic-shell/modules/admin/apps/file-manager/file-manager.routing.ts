...
import { CanDeactivateFileManagerDetails } from 'app/zdslogic-shell/modules/admin/apps/file-manager/file-manager.guards';
...
import { FileManagerFolderResolver, FileManagerItemResolver, FileManagerItemsResolver } from 'app/zdslogic-shell/modules/admin/apps/file-manager/file-manager.resolvers';
