...
import { PricingTableComponent } from 'app/zdslogic-shell/modules/admin/pages/pricing/table/table.component';
import { pricingTableRoutes } from 'app/zdslogic-shell/modules/admin/pages/pricing/table/table.routing';
